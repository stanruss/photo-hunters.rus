...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 23 2018 г., 08:47
...
('127.0.0.1', 0, 'http://photo-hunters.rus/', '', '2018-07-23 05:43:50');
...
--
ALTER TABLE `oc_api_session`
  MODIFY `api_session_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `oc_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
