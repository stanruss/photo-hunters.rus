...
INSERT INTO `oc_customer_online` (`ip`, `customer_id`, `url`, `referer`, `date_added`) VALUES ('127.0.0.1', '0', 'http://photo-hunters.rus/index.php?route=common/home', 'http://localhost:3000/index.php?route=checkout/cart', '2018-07-18 05:08:30');
...
INSERT INTO `oc_product` (`product_id`, `model`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `viewed`, `date_added`, `date_modified`) VALUES ('30', 'Product 3', '', '', '', '', '', '', '', '7', '6', 'catalog/demo/canon_eos_5d_1.jpg', '9', '1', '100.0000', '0', '9', '2009-02-03', '0.00000000', '1', '0.00000000', '0.00000000', '0.00000000', '1', '1', '1', '0', '1', '12', '2009-02-03 16:59:00', '2018-07-08 20:55:00');
...
INSERT INTO `oc_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES ('2353', '30', 'catalog/demo/canon_eos_5d_3.jpg', '0');
INSERT INTO `oc_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES ('2352', '30', 'catalog/demo/canon_eos_5d_2.jpg', '0');
...
INSERT INTO `oc_seo_url` (`seo_url_id`, `store_id`, `language_id`, `query`, `keyword`) VALUES ('844', '0', '1', 'product_id=30', 'canon-eos-5d');
...
INSERT INTO `oc_session` (`session_id`, `data`, `expire`) VALUES ('24ba083df7fc67151195041153', '{"language":"ru-ru","currency":"RUB"}', '2018-07-18 05:32:30');
INSERT INTO `oc_session` (`session_id`, `data`, `expire`) VALUES ('280375dff2b32711849f433f46', '{"user_id":"1","user_token":"x99nzmWPLEjbybGQhIfFHP7t0geY8vJs","language":"ru-ru","currency":"RUB"}', '2018-07-18 05:33:13');
...
INSERT INTO `oc_theme` (`theme_id`, `store_id`, `theme`, `route`, `code`, `date_added`) VALUES ('6', '0', 'default', 'extension/payment/cheque', '&lt;h2&gt;Инструкция по заказу&lt;/h2&gt;\n&lt;div class=&quot;well well-sm&quot;&gt;\n  &lt;p&gt;Для заказа надо...&lt;/p&gt;\n \n&lt;/div&gt;\n&lt;div class=&quot;buttons&quot;&gt;\n  &lt;div class=&quot;pull-right&quot;&gt;\n    &lt;input type=&quot;button&quot; value=&quot;{{ button_confirm }}&quot; id=&quot;button-confirm&quot; data-loading-text=&quot;{{ text_loading }}&quot; class=&quot;btn btn-primary&quot; /&gt;\n  &lt;/div&gt;\n&lt;/div&gt;\n&lt;script type=&quot;text/javascript&quot;&gt;&lt;!--\n$(\'#button-confirm\').on(\'click\', function() {\n\t$.ajax({\n\t\turl: \'index.php?route=extension/payment/cheque/confirm\',\n\t\tdataType: \'json\',\n\t\tbeforeSend: function() {\n\t\t\t$(\'#button-confirm\').button(\'loading\');\n\t\t},\n\t\tcomplete: function() {\n\t\t\t$(\'#button-confirm\').button(\'reset\');\n\t\t},\n\t\tsuccess: function(json) {\n\t\t\tif (json[\'redirect\']) {\n\t\t\t\tlocation = json[\'redirect\'];\t\n\t\t\t}\n\t\t},\n\t\terror: function(xhr, ajaxOptions, thrownError) {\n\t\t\tconsole.log(thrownError + &quot;\r\n&quot; + xhr.statusText + &quot;\r\n&quot; + xhr.responseText);\n\t\t\talert(thrownError + &quot;\r\n&quot; + xhr.statusText + &quot;\r\n&quot; + xhr.responseText);\n\t\t}\n\t});\n\n});\n//--&gt;&lt;/script&gt;\n', '2018-07-17 20:17:27');
